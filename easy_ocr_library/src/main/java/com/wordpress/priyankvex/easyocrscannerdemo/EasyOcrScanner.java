...
public class EasyOcrScanner {
    ...
    public void takePicture(){
        ...
        e.putExtra("output",
                FileProvider.getUriForFile(mActivity, mActivity.getApplicationContext().getPackageName() + ".provider", new File(this.filePathOriginal)));
//                Uri.fromFile(new File(this.filePathOriginal)));
